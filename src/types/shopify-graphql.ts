...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch("https://mama-bobs-dev.myshopify.com/api/2023-07/graphql.json", {
    method: "POST",
    ...({"headers":{"X-Shopify-Storefront-Access-Token":"2a3dc1d334ed525ffdff58bbeb9e0f3b"}}),
