...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch("https://s3eish-fz.myshopify.com/api/2023-07/graphql.json", {
    method: "POST",
    ...({"headers":{"X-Shopify-Storefront-Access-Token":"2a86bb37ce63ce9b834f25d5c6add95a"}}),
